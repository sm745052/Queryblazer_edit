...
OUTPUT_FORMAT=out.unseen.dstc7.qb
...
python3 script/complete.py --encoder $ENCODER --model $LANGUAGE_MODEL.fst --precomputed $PRECOMPUTED < $LOG_FILE > $OUTPUT_DIR/$OUTPUT_FORMAT
