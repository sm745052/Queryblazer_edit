...
# INPUT
LOG_FILE=data/cDDC/seen/test_formatted.txt
OUTPUT_FORMAT=out.seen.cddc.qb.torerank
...
python3 script/fcomplete.py --encoder $ENCODER --model $LANGUAGE_MODEL.fst --precomputed $PRECOMPUTED < $LOG_FILE > $OUTPUT_DIR/$OUTPUT_FORMAT
